...
<html lang="en">
 ...
 <body> 
  <main>
    <header>
        <h1><i class="logo fa fa-home" style="color:#D6CE15"></i>
        <a href="index.php">Web Developer Examples and Resources by Chris Navoczynski</a></h1>
     <nav id="cssmenu">
      <ul>
         <li><a href="../index.php"><i class="fa fa-fw fa-institution"></i> IT162</a></li>
         <li><a href="index.php"><i class="fa fa-fw fa-home"></i> BIG Site</a></li>
         <li><a href="gallery.php"><i class="fa fa-fw fa-picture-o"></i> Lightbox II Gallery</a></li>
        ...
        <li><a href="contactme.php"><i class="fa fa-fw fa-envelope-o"></i> Contact Me</a></li>
      </ul>
     </nav>
    </header>
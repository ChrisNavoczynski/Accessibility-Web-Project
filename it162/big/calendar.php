<?php include('includes/header.php');?>
    ...
    <!-- START LEFT COLUMN -->
    <section>
        <h2>Monthly Events and Important Dates</h2>
    ...
    <!-- START RIGHT COLUMN -->
     <aside>
        <div class = 'ainfo'>
        <h2>Additional Calendar Information Details</h2>
        <h3>IT162 BIG Project Due </h3>
        <p>The Last day to turn in the final project is Sunday August 23rd. 2020.  
            The IT162 Final Project is the BIG Website Project.</p>

            <ul>
            <li><a href="https://canvas.seattlecentral.edu/courses/1949720/assignments/19424625?return_to=https%3A%2F%2Fcanvas.seattlecentral.edu%2Fcalendar%23view_name%3Dmonth%26view_start%3D2020-08-12" 
            target="_blank">Final Assignment</a></li>
            </ul>
        <br>

        <h3>Tibet Fest!</h3>
        <p>Seattle Center Festál presents Tibet Fest (pronounced T-bet Fest) 
            in partnership with the Tibetan Association of Washington (TAW). 
            The festival showcases traditional and contemporary Tibetan art, 
            music, dance, art and more. This event is free to the public.</p>
